...
// Transformation from image coordinates to 2d scene coordinates.
export function imgCoordToSceneCoord(width, height) {
  return (imgCoord) => {
    return [
      -(imgCoord[0] - width / 2.0),
      -(imgCoord[1] - height / 2.0)
      ];
  }
}